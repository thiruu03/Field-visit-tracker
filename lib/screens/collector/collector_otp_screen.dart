...
class CollectorOtpScreen extends StatefulWidget {
  final String employeeId;
  const CollectorOtpScreen({super.key, required this.employeeId});

  @override
  State<CollectorOtpScreen> createState() => _OtpScreenState();
}

class _OtpScreenState extends State<CollectorOtpScreen> {
  ...
  void verifyOtp(BuildContext context) async {
    ...
    if (await success) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) => CollectorMainScreen(
